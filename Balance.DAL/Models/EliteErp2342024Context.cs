...
namespace Balance.DAL.Models;

public partial class EliteErp2342024Context : DbContext
{
    public EliteErp2342024Context()
    {
    }

    public EliteErp2342024Context(DbContextOptions<EliteErp2342024Context> options)
        : base(options)
    {
    }
